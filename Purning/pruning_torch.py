...
scripted_float_model_file = 'VGG16_pruning_scripted_40.pth'
scripted_default_pruned_model_file = 'VGG16_pruning_scripted_40.pth'
...
index=[0,4,8,12,16,20,24,28,32,36,40,44,48]
for n in index:
    pruning_idxs = strategy(model.features[n].weight, amount=0.4,round_to=4) 
    pruning_plan = DG.get_pruning_plan( model.features[n], tp.prune_conv, idxs=pruning_idxs)
    pruning_plan.exec()
...
torch.save(model,"./checkpoint/test0319_module_full.pth")
